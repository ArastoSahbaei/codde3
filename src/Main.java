...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String weaponName = ""; // PLEASE ENTER YOUR SEARCH WORD HERE FOR WEAPON

        searchWeapon(weaponName.toLowerCase());
    }
            ...
            switch (weaponSearchName) {
                case "hammer":
                    if (goodGuy.weaponName.equals(weaponSearchName)) {
                        ...
                        continueLoop = false;
                    } else if (evilGuy.weaponName.equals(weaponSearchName)) {
